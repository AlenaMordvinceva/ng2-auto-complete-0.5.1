...
import { AutoCompleteDirective, AutoCompleteComponent } from "ng2-auto-complete";
  ...
  template: `
    ...
    <input ng2-auto-complete 
      ...
      [source]="arrayOfStrings"
       placeholder="enter text"/><br/>selected: {{model1 | json}}<br/><br/>
    ...
    <input 
      ...
      placeholder="enter text"/><br/> selected: {{model2 | json}}<br/><br/>
    ...
    <input ng2-auto-complete [source]="arrayOfKeyValues2"
      ...
      display-property-name="name"/><br/>selected: {{model3 | json}}<br/><br/>
    ...
    <input  ng2-auto-complete
      ...
      min-chars="2" /><br/>selected: {{model4 | json}}<br/><br/>
 `,
  providers: [HTTP_PROVIDERS],
  directives: [AutoCompleteDirective, FORM_DIRECTIVES, AutoCompleteComponent],
  styles: [`
